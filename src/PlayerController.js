...
export class PlayerController {
  constructor(environment, gameAssets) {
    ...
    this.fireButtonsInit();
    this.directionButtonInit();
  }
  fireButtonsInit() {
    document.getElementById("fire-bullet").addEventListener("click", (el) => {
  ...
  directionButtonInit() {
    ...
    document.getElementById("ship-right").addEventListener("click", (el) => {
  ...
  fireButtonClick() {
    this.bullets.push(
      new PlayerBullet(this.gameAssets, this.scene, this.playerMesh)
    );
